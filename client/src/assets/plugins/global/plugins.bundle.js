...
window.FormValidation = require("../formvalidation/dist/amd/index.js");
window.FormValidation.plugins.Bootstrap = require("../formvalidation/dist/amd/plugins/Bootstrap.js").default;
...
require('../../js/vendors/plugins/bootstrap-datepicker.init.js');
...
require('../../js/vendors/plugins/bootstrap-timepicker.init.js');
...
require('../../js/vendors/plugins/bootstrap-switch.init.js');
...
require('../../js/vendors/plugins/bootstrap-markdown.init.js');
...
require('../../js/vendors/plugins/bootstrap-notify.init.js');
...
window.sessionTimeout = require('../bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js');

// JQuery Idletimer - provides you a way to monitor user activity with a page: https://github.com/thorst/jquery-idletimer
require('../jquery-idletimer/idle-timer.min.js');
