    ...
    <TheHeaderMobile />
		<div class='kt-grid kt-grid--hor kt-grid--root'>
			<div class='kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page'>
				<button id='kt_aside_close_btn' type='button' class='kt-aside-close'>
...
export default {
  ...
  beforeMount () {
    document.body.setAttribute(
      'class',
      'kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-aside--enabled kt-aside--fixed kt-page--loading'
