...
export default {
  beforeMount () {
    ...
    document.body.className = "header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize aside-minimize-hoverable"
  }
}
</script>
...
@import "assets/plugins/formvalidation/dist/css/formValidation.css";
