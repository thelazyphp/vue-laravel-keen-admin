 ...
 * @method static bool notEmpty(mixed $source)
 ...
 * @method static \App\Parsing\Rule pregSplit(string $pattern, int $limit, int $flags)
 * @method static \App\Parsing\Rule explode(string $delimiter, null|int $limit)
 * @method static \App\Parsing\Rule implode(string $delimiter)
 * @method static \App\Parsing\Rule map(callable $callback)
 * @method static \App\Parsing\Rule filter(callable $callback, int $flag)
