...
class UserPolicy
{
    ...
    /**
     * Determine whether the user can view the model profile.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return mixed
    ...
    /**
     * Determine whether the user can view the model account.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return mixed
    ...
    /**
     * Determine whether the user can update the model account.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return mixed
    ...
    /**
     * Determine whether the user can delete the model account.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return mixed
